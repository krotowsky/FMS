...
class FleetController extends BaseController
{
    ...
    /**
    * @Route("/admin/fleet/gruszki",name="app_admin_fleet_gruszki")
    * @IsGranted("ROLE_WRITER")
    */
    public function gruszkiIndex(){
        $categories = $this->categorieRepository->findAll();
        return $this->render("admin/categorie/categorie.html.twig",["categories"=>$categories]);
    }

    /**
     * @Route("/admin/fleet/pompy",name="app_admin_fleet_pompy")
     * @IsGranted("ROLE_WRITER")
     */
    public function pompyIndex(){
        $categories = $this->categorieRepository->findAll();
        return $this->render("admin/categorie/categorie.html.twig",["categories"=>$categories]);
    }

    /**
     * @Route("/admin/fleet/pompogruszki",name="app_admin_fleet_pompogruszki")
     * @IsGranted("ROLE_WRITER")
     */
    public function pompogruszkiIndex()
    {
        $categories = $this->categorieRepository->findAll();
        return $this->render("admin/categorie/categorie.html.twig",["categories"=>$categories]);
